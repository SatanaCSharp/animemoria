---
title: 'Invariant'
source: 'https://developer.mozilla.org/en-US/docs/Glossary/Invariant'
author:
published: 2025-07-11
created: 2026-04-27
description: "In program semantics, an invariant of a piece of code is a condition that is provably true throughout the execution of that code. Defining invariants helps to reason about the code's correctness and behavior."
tags:
  - 'clippings'
---
