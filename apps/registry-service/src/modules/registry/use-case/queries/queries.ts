...
import { GetServiceDescriptionsQueryProcessor } from 'modules/registry/use-case/queries/get-service-descriptions-by-variant.query';

export const queries = [
  GetServiceDescriptionsQueryProcessor,
